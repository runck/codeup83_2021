...
public class BfourOfAkindSet extends BaseCardSet {
    public BfourOfAkindSet(){
        setType = "FourOfAKind";
    }
    public static final int TYPE_CARD_NAME_TYPE_COUNT = 2;
    public static final int TYPE_CARD_COUNT_MORE = 4;
    public static final int TYPE_CARD_COUNT_LESS = 1;
